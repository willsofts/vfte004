        ...
        <div class="row row-height">
          <div class="col-height col-md-10">
            ...
            <div class="input-group has-validation" :class="{'has-error': v$.nameen.$error}">
              <input type="text" ref="nameen" v-model="localData.nameen" id="nameen" class="form-control input-md" /> 
        ...
        <div class="row row-height">
          <div class="col-height col-md-10">
            ...
            <div class="input-group has-validation" :class="{'has-error': v$.nameth.$error}">
              <input type="text" ref="nameth" v-model="localData.nameth" id="nameth" class="form-control input-md" /> 
              <label class="required">*</label>
            </div>
        ...
        $.ajax({
          ...
          success: (data) => {
            ...
            successbox(() => {
              ...
              this.resetRecord();
              setTimeout(() => { this.$refs.nameen.focus(); },100);
